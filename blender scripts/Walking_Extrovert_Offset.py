...
#ARM
    ...
    "mixamorig:RightShoulder": Quaternion((0,0,1), math.radians(20)),
    "mixamorig:LeftShoulder": Quaternion((0,0,1), math.radians(-20)),
    "mixamorig:Neck": Quaternion((1,0,0), math.radians(-3)),
