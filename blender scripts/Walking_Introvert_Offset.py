...
#ARM
    ...
    "mixamorig:RightShoulder": Quaternion((1,0,0), math.radians(10)),
    "mixamorig:RightForeArm": Quaternion((0,0,1), math.radians(20)),
    "mixamorig:LeftShoulder": Quaternion((1,0,0), math.radians(10)),
    "mixamorig:LeftForeArm": Quaternion((0,0,1), math.radians(-20)),    
    "mixamorig:Neck": Quaternion((1,0,0), math.radians(8)),
    "mixamorig:Spine2": Quaternion((1,0,0), math.radians(3)),
    "mixamorig:Spine1": Quaternion((1,0,0), math.radians(1)),
    "mixamorig:LeftUpLeg": Quaternion((0,0,1), math.radians(-2)),
    "mixamorig:RightUpLeg": Quaternion((0,0,1), math.radians(2))
    
}  # type: Dict[str, Quaternion]

OFFSETS_DB_APOSE = {

    #"mixamorig:LeftUpLeg": Quaternion((0,0,1), math.radians(-6.30)),
    #"mixamorig:LeftShoulder":  Quaternion((0,0,1), math.radians(6.0)),
    #"mixamorig:LeftArm": Quaternion((0,0,1), math.radians(24.0)) @ Quaternion((1,0,0), math.radians(6.0)),
    #"mixamorig:LeftForeArm": Quaternion((0,0,1), math.radians(-3.80)) @ Quaternion((1,0,0), math.radians(-14.50)),

    #"mixamorig:RightUpLeg": Quaternion((0,0,1), math.radians(6.30)),
    #"mixamorig:RightShoulder":  Quaternion((0,0,1), math.radians(-6.0)),
    #"mixamorig:RightArm": Quaternion((0,0,1), math.radians(-24.0)) @ Quaternion((1,0,0), math.radians(6.0)),
    #"mixamorig:RightForeArm": Quaternion((0,0,1), math.radians(+3.80)) @ Quaternion((1,0,0), math.radians(-14.50)),
...
def is_t_pose(arm_obj: bpy.types.Object) -> bool:
    ...
    #
    shoulder_pos = arm_obj.pose.bones['mixamorig:LeftArm'].bone.head_local
    wrist_pos = arm_obj.pose.bones['mixamorig:LeftForeArm'].bone.tail_local
...
def offset_bone_animation(action: bpy.types.Action, bone_name: str, offset: Quaternion) -> None:
    ...
    #print('pose.bones["{0}"].rotation_quaternion'.format(bone_name))
